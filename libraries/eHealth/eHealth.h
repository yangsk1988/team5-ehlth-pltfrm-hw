...
#define BP_VECTOR_LEN 80
#define GLUCO_VECTOR_LEN 8
...
class eHealthClass {
	...
	//***************************************************************
		...
		*/	int version(void);
		...
		glucoseData glucoseDataVector[GLUCO_VECTOR_LEN];
		...
		bloodPressureData bloodPressureDataVector[BP_VECTOR_LEN];
	...
	//***************************************************************
		...
		//!It stores the number of data of the Blood pressure monitor.
		uint8_t BPlength;
